	 ...
	 WebElement Objchpd=Driver.findElement(By.xpath("html/body/div[3]/ul/li[2]/a"));
		...
		String l="Badri";
			...
			String  str=Driver.findElement(By.xpath("html/body/form/div[2]/div[1]/div[2]/div[1]/h2")).getText();
		     ...
		     Objback.click();
		     WebElement Objselectemp=Driver.findElement(By.name("chkLocID[]") )  ;
		     Objselectemp.click();
		     WebElement Objdelete=Driver.findElement(By.xpath(".//*[@id='standardView']/div[3]/div[1]/input[2]"))  ;
		     Objdelete.click();
		     WebElement Objsuccdel=Driver.findElement(By.xpath("html"))  ;
		     Objsuccdel.isDisplayed();
		     if(Objsuccdel.isDisplayed())
		     {
		    	 System.out.println("succ del");
		     }
		     else
		     {
		    	 System.out.println("succ not del");
		     }
