		...
		else
		{
		   ...
		   WebElement Objn=Driver.findElement(By.name("txtLocDescription"));
			...
			Alert A1=Driver.switchTo().alert();
			 ...
			 WebElement Objdele=Driver.findElement(By.xpath("html/body/div[1]/div[2]/form/table/tbody/tr[11]/td[1]/input"));
			 Objdele.click();
			 WebElement Objdelee=Driver.findElement(By.xpath("html/body/div[1]/div[2]/form/div[4]/div[1]/input[2]"));
			 Objdelee.click();
			 System.out.println(A1.getText());
			 A1.accept();
			 WebElement Objupsds=Driver.findElement(By.xpath("html/body/div[1]/div[2]/form/div[2]/span"));
			 if(Objupsds.isDisplayed())
			 {
